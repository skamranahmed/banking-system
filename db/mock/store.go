...
// Source: github.com/skamranahmed/banking-system/db/sqlc (interfaces: Store)
...
import (
	...
	sqlc "github.com/skamranahmed/banking-system/db/sqlc"
)
...
func (m *MockStore) TransferTxn(arg0 context.Context, arg1 sqlc.TransferTxnParams) (sqlc.TransferTxnResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTxn", arg0, arg1)
	ret0, _ := ret[0].(sqlc.TransferTxnResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
